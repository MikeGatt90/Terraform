...
resource "aws_route_table" "project_rt" {
  ...
  route {
    ...
    gateway_id = "igw-037d7aff46166d6ab"
  }
  tags = {
    Name = "project-rt"
  }
...
resource "aws_instance" "web1" {
  ...
  user_data                   = <<-EOF
        ...
        systemctl start 
        systemctl enable
        echo '<h1>LUIT Gold Team!</h1>' > /usr/share/nginx/html/index.html
        EOF
...
resource "aws_instance" "web2" {
  ...
  user_data                   = <<-EOF
        ...
        systemctl start 
        systemctl enable
        echo '<h1>Terraform Two-Tier Architecture</h1>' > /usr/share/nginx/html/index.html
        EOF
